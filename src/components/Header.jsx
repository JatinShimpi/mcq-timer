...
export default function Header({ onHomeClick, onDashboardClick, onSignInClick, showBack, theme, onToggleTheme, currentView }) {
    ...
    const getProviderIcon = () => {
        ...
        switch (user.provider) {
            ...
            default: return <span className="user-avatar-initial">{user.name?.[0]?.toUpperCase() || '?'}</span>;
        }
    };
    ...
    return (
        <header className="header">
            ...
            <div className="header-right">
                {currentView === 'home' && (
                    <Button className="btn btn-ghost" onPress={onDashboardClick}>
                        📊 Dashboard
                    </Button>
                )}
                <Button
